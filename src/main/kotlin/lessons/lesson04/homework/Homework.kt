...
// Ошибка: в Kotlin логические значения пишутся с маленькой буквы
...
// Ошибка: имя переменной не может начинаться с цифры
...
// Ошибка: true/false пишутся с маленькой буквы
val v30: Boolean = false

val v31: Double = 0.007

// Ошибка: использованы неправильные кавычки (“ ”)
val v32: String = "🤯"

val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)

// Ошибка: Char может хранить только один символ, а тут строка, и кавычки неправильные (‘ ’)
...
val séanceLetter: Char = 'W'
val sugarSpoons: Int = 1
val foodDeliveryCosts: List<Double> = listOf(1100.10, 1200.50, 7000.30)
val queueLength: Double = 12.000000001
val isBugClosed: Boolean = true
val kettleWhistles: Int = 10
val catKeyPresses: Long = 9876543210
val starCountingAttempts: Long = 9999999999999
val mattressAirMass: Double = 1234.56789
